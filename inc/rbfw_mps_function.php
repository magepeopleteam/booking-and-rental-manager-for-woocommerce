...
if ( ! class_exists( 'RBFW_MPS_Function' ) ) {
    class RBFW_MPS_Function {
        ...
        public function rbfw_mps_place_order_form_submit(){
            ...
            $dress_size = !empty($_POST['dress_size']) ? strip_tags($_POST['dress_size']) : '';
            ...
            if(empty($errors)){
                ...
                if(is_user_logged_in()){
                    ...
                    if($current_user_email == $email){
                        ...
                        $order = $this->rbfw_mps_create_order($post_id, $rent_type, $start_date, $start_time, $end_date, $end_time, $pickup_point, $dropoff_point, $type_info, $service_info, $payment_method, $first_name, $last_name, $email, $package, $dress_size, '', '', '', '', $item_quantity,$variation_info);
        ...
        public function rbfw_mps_create_order($post_id, $rent_type, $start_date = null, $start_time = null, $end_date = null, $end_time = null, $pickup_point = null, $dropoff_point = null, $type_info = array(), $service_info = array(), $payment_method = null, $first_name = null, $last_name = null, $email = null, $package = null, $dress_size = null, $order_status = null, $payment_id = null, $payer_id = null, $reference = null, $item_quantity = null, $variation_info = array()){
            ...
            if($rent_type == 'bike_car_sd' || $rent_type == 'appointment'){
                ...
                $ticket_info = $rbfw_bikecarsd->rbfw_bikecarsd_ticket_info($rbfw_id,$start_date,$end_date,$type_info_merged_array,$service_info_merged_array,$start_time);
            ...
            elseif(($rent_type == 'bike_car_md') || ($rent_type == 'dress') || ($rent_type == 'equipment') || ($rent_type == 'others')){
                ...
                $ticket_info = $BikeCarMdClass->rbfw_bikecarmd_ticket_info($rbfw_id, $start_datetime, $end_datetime, $pickup_point, $dropoff_point, $service_info_merged,$duration_cost,$service_cost,$ticket_total_price,$dress_size,$item_quantity,$start_date,$end_date,$start_time,$end_time,$variation_info, $discount_type, $discount_amount);
        ...
        public function rbfw_mps_user_login(){
            ...
            if($rent_type == 'bike_car_md' || $rent_type == 'dress' || $rent_type == 'equipment' || $rent_type == 'others'):
                ...
                $dress_size = isset($_POST['dress_size']) ? strip_tags($_POST['dress_size']) : '';
                $service_info = !empty($_POST['service_info']) ? $_POST['service_info'] : [];
                $variation_info = !empty($_POST['variation_info']) ? $_POST['variation_info'] : [];
                $g_services = get_post_meta($post_id,'rbfw_extra_service_data',true);
                $g_services = !empty($g_services) ? array_column($g_services, 'service_price', 'service_name') : [];
            ...
            if(is_user_logged_in()){
                ...
                $content .= '<div class="rbfw_mps_user_form_wrap">';
                        ...
                        $content .= wp_nonce_field( 'rbfw_mps_place_order_form_submit', 'rbfw_mps_order_place_nonce' );
