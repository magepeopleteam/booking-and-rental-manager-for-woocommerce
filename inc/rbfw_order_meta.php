                    ...
                    <tbody>
                        ...
                        <?php if ($rbfw_return_security_deposit_amount) : ?>
                            <tr>
                                ...
                                <td><?php echo wc_price(esc_html($rbfw_return_security_deposit_amount)); ?></td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($unique_tickets as $unique_ticket) {
                                ...
                                if ($show_columns['duration_cost']) echo '<td>' . wc_price(esc_html($unique_ticket['duration_cost']) ?? 0) . '</td>';
                                if ($show_columns['resource_cost']) echo '<td>' . wc_price(esc_html($unique_ticket['service_cost']) ?? 0) . '</td>';
                                if ($show_columns['tax']) echo '<td>' . wc_price(esc_html($unique_ticket['rbfw_mps_tax']) ?? 0) . '</td>';
                                if ($show_columns['discount']) echo '<td>' . wc_price(esc_html($unique_ticket['discount_amount']) ?? 0) . '</td>';
                                if ($show_columns['security_deposit']) echo '<td>' . wc_price(esc_html($unique_ticket['security_deposit_amount']) ?? 0) . '</td>';
                                if ($show_columns['total_cost']) echo '<td>' . wc_price(esc_html($unique_ticket['ticket_price']) ?? 0) . '</td>';
                                ...
                                if (!empty($service_items)) {
                                    ...
                                    foreach ($service_items as $item) {
                                        ...
                                        if ($item['service_price_type'] == 'day_wise') {
                                            echo '<td>(' . wc_price(esc_html($item['price'])) . ' x ' . esc_html($item['quantity']) . ' x ' . esc_html($ticket_info['total_days']) . ' = ' . wc_price($item['price'] * $item['quantity'] * $ticket_info['total_days']) . ')</td>';
                                        } else {
                                            echo '<td>(' . wc_price(esc_html($item['price'])) . ' x ' . esc_html($item['quantity']) . ' = ' . wc_price($item['price'] * $item['quantity']) . ')</td>';
                                        }
                                        echo '</tr>';
                                    }
                                }
        ...
        <div class="rbfw_order_meta_box_body">
                    ...
                    <table class="wp-list-table widefat fixed striped table-view-list" style="display: none">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo rbfw_get_type_label(esc_html($rent_type)); ?></td>
                            </tr>
                                                    ...
                                                    <?php foreach ($value as $key1=>$item){ ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if($item['service_price_type']=='day_wise'){
                                                                    echo '('.wc_price(esc_html($item['price'])). 'x'. esc_html($item['quantity']) . 'x' .$total_days .'='.wc_price($item['price'] * $item['quantity'] * $total_days).')';
                                                                }else{
                                                                    echo '('.wc_price(esc_html($item['price'])). 'x'. esc_html($item['quantity']) .'='.wc_price($item['price']*$item['quantity']).')';
                                                                }
                                                                ?>
                                                            </td>
                                                        </tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo wc_price(esc_html($duration_cost)); ?></td>
                            </tr>
                            <?php if($service_cost){ ?>
                                <tr>
                                    ...
                                    <td><?php echo wc_price(esc_html($service_cost)); ?></td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo wc_price(esc_html($tax)); ?></td>
                            </tr>
                            <?php } ?>
                            ...
                            <?php if($discount_amount){ ?>
                                <tr>
                                    ...
                                    <td><?php echo wc_price(esc_html($discount_amount)); ?></td>
                                </tr>
                            <?php } ?>
                            ...
                            <?php if($security_deposit_amount){ ?>
                                <tr>
                                    ...
                                    <td><?php echo wc_price(esc_html($security_deposit_amount)); ?></td>
                                </tr>
                            <?php } ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo wc_price(esc_html($total_cost)).' '.esc_html($tax_status); ?></td>
                            </tr>
                        </tbody>
                    </table>
                <?php } ?>
            ...
            <table class="wp-list-table widefat fixed striped table-view-list" style="display: none">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong><?php rbfw_string('rbfw_text_total_cost',esc_html__('Total Cost','booking-and-rental-manager-for-woocommerce')); echo ':'; ?></strong></td>
                        <td><?php echo wc_price(esc_html($grand_total)); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
