	...
	if ( ! class_exists( 'MP_SUPER_SLIDER' ) ) {
		class MP_SUPER_SLIDER {
			...
			public function super_slider_script() {
				wp_enqueue_style( 'super_slider_style', RBFW_PLUGIN_URL . '/assets/mp_style/super_slider.css', array(), time() );
				wp_enqueue_script( 'super_slider_script', RBFW_PLUGIN_URL . '/assets/mp_style/super_slider.js', array(), time(), true );
			}
