<?php
	...
	function rbfw_add_cart_item_func( $cart_item_data, $rbfw_id ) {
		...
		$rbfw_service_info_all         = isset( $_POST['rbfw_service_info'] ) ? array_map( 'sanitize_text_field', $_POST['rbfw_service_info'] ) : [];
		...
		if ( $rbfw_rent_type == 'resort' ) {
			...
			$rbfw_room_price_category = isset( $_POST['rbfw_room_price_category'] ) ? sanitize_text_field( $_POST['rbfw_room_price_category'] ) : '';
			$rbfw_room_info_all       = isset( $_POST['rbfw_room_info'] ) ? array_map( 'sanitize_text_field', $_POST['rbfw_room_info'] ) : [];
			...
			$rbfw_bikecarsd_selected_date = isset( $_POST['rbfw_bikecarsd_selected_date'] ) ? sanitize_text_field( $_POST['rbfw_bikecarsd_selected_date'] ) : '';
			$bikecarsd_selected_date      = isset( $_POST['rbfw_bikecarsd_selected_date'] ) ? sanitize_text_field( $_POST['rbfw_bikecarsd_selected_date'] ) : '';
			$rbfw_bikecarsd_selected_time = isset( $_POST['rbfw_start_time'] ) ? sanitize_text_field( $_POST['rbfw_start_time'] ) : '';
			...
			$rbfw_type_info_all  = isset( $_POST['rbfw_bikecarsd_info'] ) ? array_map( 'sanitize_text_field', $_POST['rbfw_bikecarsd_info'] ) : [];
			...
			$rbfw_service_infos_post = isset( $_POST['rbfw_service_price_data'] ) ? array_map( 'sanitize_text_field', $_POST['rbfw_service_price_data'] ) : [];
			$rbfw_service_infos      = [];
