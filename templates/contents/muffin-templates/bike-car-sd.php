			...
			<div class="rbfw_muff_pricing">
				<div class="rbfw_muff_pricing_card">
					...
					<div class="rbfw_muff_pricing_card_col2">
						...
						<?php if (!empty($price)) : ?>
						<div class="rbfw_muff_pricing_card_price"><span class="rbfw_muff_pricing_card_price_badge"><?php echo rbfw_mps_price($price); ?></span><span> / <?php echo esc_html($prices_start_at); ?></span></div>
						<?php endif; ?>
