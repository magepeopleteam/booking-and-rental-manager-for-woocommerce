...
<tr class="rbfw_bike_car_sd_price_table_row" data-key="">
    ...
    <td class="rbfw_time_inventory_enable duration_enable <?php echo ($manage_inventory_as_timely=='on' && $enable_specific_duration=='off')?'rbfw_hide':''  ?>">
    ...
    <td class="rbfw_time_inventory_enable duration_disable <?php echo ($manage_inventory_as_timely=='on' && $enable_specific_duration=='on')?'rbfw_hide':'' ?>">
