...
<tr class="rbfw_bike_car_sd_price_table_row" data-key="">
    <td>
        <input type="text" class="rbfw_type_title" name="rbfw_bike_car_sd_data[<?php echo esc_attr($total_row); ?>][rent_type]" value="" placeholder="<?php echo esc_attr__('1 hour bike rent', 'booking-and-rental-manager-for-woocommerce'); ?>">
    </td>
    <td>
