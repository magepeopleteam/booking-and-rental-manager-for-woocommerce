                ...
                <div class="rbfw_dt_pricing_card">
                    ...
                    <div class="rbfw_dt_pricing_card_col2">
						<?php if ( ! empty( $rbfw_daylong_rate_smallest_price ) ) : ?>
                            <div class="rbfw_dt_pricing_card_price"><?php echo esc_html( $rbfw_daylong_rate_smallest_price ); ?><span> /


                                    <?php
                                    if($rbfw->get_option_trans('rbfw_text_daylong', 'rbfw_basic_translation_settings') && want_loco_translate()=='no'){
                                        echo esc_html($rbfw->get_option_trans('rbfw_text_daylong', 'rbfw_basic_translation_settings'));
                                    }else{
                                        echo esc_html__('DAYLONG','booking-and-rental-manager-for-woocommerce');
                                    }
                                    ?>
						...
						<?php if ( ! empty( $rbfw_daynight_rate_smallest_price ) ) : ?>
                            <div class="rbfw_dt_pricing_card_price"><?php echo esc_html( $rbfw_daynight_rate_smallest_price ); ?><span> /


                                    <?php
                                    if($rbfw->get_option_trans('rbfw_text_daynight', 'rbfw_basic_translation_settings') && want_loco_translate()=='no'){
                                        echo esc_html($rbfw->get_option_trans('rbfw_text_daynight', 'rbfw_basic_translation_settings'));
                                    }else{
                                        echo esc_html__('DAYNIGHT','booking-and-rental-manager-for-woocommerce');
                                    }
                                    ?>
