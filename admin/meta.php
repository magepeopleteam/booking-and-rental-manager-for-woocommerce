			...
			<table class="form-table rbfw_item_type_table">
				...
				<tr class="rbfw_enable_start_end_date_switch_row" <?php if ( $rbfw_item_type == 'bike_car_sd' || $rbfw_item_type == 'appointment' || $rbfw_item_type == 'resort') { echo 'style="display:none"'; } ?>>
					<td>
						...
						<div class="rbfw_alert_info"><i class="fa-solid fa-circle-info"></i> <?php esc_html_e( 'Enable/Disable start date-time-picker and end date-time-picker on front-end. The custom settings is for the specific date booking functionality. So, the datepicker and timepicker will be hidden. Only daily rate will be applied for custom date. Hourly rate is not applicable for custom date.', 'booking-and-rental-manager-for-woocommerce' ); ?></div>
					</td>
				</tr>
