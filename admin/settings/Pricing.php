	...
	if ( ! class_exists( 'RBFW_Pricing' ) ) {
		class RBFW_Pricing {
			...
			public function rent_type( $post_id ) {
                ...
                <section>
                    <div>
                        <label for=""><?php esc_html_e( 'Rent Types', 'booking-and-rental-manager-for-woocommerce' ); ?></label>
                    ...
                    <select name="rbfw_item_type" id="rbfw_item_type">
                        <?php foreach ( $item_type as $key => $value ): ?>
                            <option <?php echo ( $key == $rbfw_item_type ) ? 'selected="selected"' : ''; ?> value="<?php echo esc_attr( $key ); ?>">
                                                        ...
                                                        foreach ( $value['cat_services'] as $service ) {
                                                            ...
                                                            <div class="item">
                                                                ...
                                                                <label class="" for="rbfw_dt_sidebar_switch-on">
                                                                    <input name="rbfw_service_category_price[<?php echo esc_attr( $i ); ?>][cat_services][<?php echo esc_attr( $c ); ?>][service_price_type]" type="radio" <?php echo ( $service_price_type == 'one_time' ) ? 'checked' : ''; ?> id="rbfw_dt_sidebar_switch-on" value="one_time">
                                                                ...
                                                                <label class="checked" for="rbfw_dt_sidebar_switch-off">
                                                                    <input name="rbfw_service_category_price[<?php echo esc_attr( $i ); ?>][cat_services][<?php echo esc_attr( $c ); ?>][service_price_type]" type="radio" <?php echo ( $service_price_type == 'day_wise' ) ? 'checked' : ''; ?> id="rbfw_dt_sidebar_switch-off" value="day_wise">
                                ...
                                <div class="services_category_wrapper">
                                    <div class="field-list <?php echo esc_attr( $field_id ); ?>">
                                        <div class="service_category_inner_wrap">
                                            ...
                                            <div class="service_category_inner_item_wrap sortable">
                                                <div class="item">
                                                    <a href="#rbfw_services_icon_list_wrapper" class="rbfw_service_icon_btn btn" data-key="0"><i class="fas fa-circle-plus"></i> <?php echo esc_html__( 'Icon', 'booking-and-rental-manager-for-woocommerce' ); ?></a>
                                                    <div class="rbfw_service_icon_preview p-1" data-key="0"></div>
                                                    <input type="hidden" name="rbfw_service_category_price[0][cat_services][0][icon]" value="" data-key="0" class="rbfw_service_icon"/>
                                                    <input type="text" name="rbfw_service_category_price[0][cat_services][0][title]" placeholder="<?php echo esc_attr__( 'Service Title', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="" data-key="0"/>
                                                    <input type="text" name="rbfw_service_category_price[0][cat_services][0][price]" placeholder="<?php echo esc_html__( 'Price', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="" data-key="0"/>
                                                    <input type="text" name="rbfw_service_category_price[0][cat_services][0][stock_quantity]" placeholder="<?php echo esc_html__( 'Stock', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="" data-key="0"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
			...
			public function category_service_price( $post_id ) {
                ...
                <div class="rbfw_general_price_config_wrapper <?php echo esc_attr( $section_visibility ); ?>">
                    <?php $this->panel_header( esc_html__( 'Service item price settings ', 'booking-and-rental-manager-for-woocommerce' ), esc_html__( 'Service price settings with category.', 'booking-and-rental-manager-for-woocommerce' ) ); ?>
                    <section>
                        <div>
                            <label>
                                <?php echo esc_html__( 'Enable Category service price ', 'booking-and-rental-manager-for-woocommerce' ); ?>
                            </label>
                            <span><?php echo esc_html__( 'You can enable/disable this section by switching this button.', 'booking-and-rental-manager-for-woocommerce' ); ?></span>
                        </div>
                        <label class="switch">
                    ...
                    <div id='field-wrapper-<?php echo esc_attr( 'rbfw_service_category_price' ); ?>' class="field-wrapper field-text-multi-wrapper field-text-multi-wrapper-rbfw_service_category_price <?php echo esc_attr( ( $enable_service_price == 'on' ) ? 'show' : 'hide' ) ?>">
                        <?php
                            $options          = array(
                                ...
                                'placeholder' => esc_attr__( 'Service Name', 'booking-and-rental-manager-for-woocommerce' ),
                            );
                        ...
                        <script>
                            ...
                            jQuery(document).on('click', '.rbfw_service_icon_btn', function (e) {
                                ...
                                jQuery(document).on('click', '.ggggg label', function (e) {
                                    ...
                                    jQuery('.rbfw_service_category_table tr[data-cat="' + selected_data_cat + '"]').find('.rbfw_service_icon_preview[data-key="' + selected_data_key + '"]').html('<i class="fas fa-' + selected_val + '"></i>');
                                    jQuery('#rbfw_features_icon_list_wrapper').mage_modal('close');
                                });
                            });
                        </script>
                    </div>
            ...
            public function bike_car_single_day( $post_id ) {
                ...
                <div class="rbfw_bike_car_sd_wrapper <?php echo esc_attr( $rbfw_item_type == 'bike_car_sd' || $rbfw_item_type == 'appointment' ? 'show' : 'hide' ); ?>">
                    <section class="manage_inventory_as_timely ">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="manage_inventory_as_timely" value="<?php echo esc_attr( $manage_inventory_as_timely == 'on' ? 'on' : 'off' ); ?>" <?php checked( $manage_inventory_as_timely, 'on' ); ?>>
                            <span class="slider round"></span>
                        </label>
                    </section>
                    <div class="rbfw_time_inventory rbfw_item_stock_quantity <?php echo esc_attr( $manage_inventory_as_timely == 'off' ? 'rbfw_hide' : '' ); ?>">
                        ...
                        <section class="rbfw_item_quantiry_duration">
                            ...
                            <label class="switch">
                                <input type="checkbox" class="enable_specific_duration" name="enable_specific_duration" value="<?php echo esc_attr( $enable_specific_duration == 'on' ? 'on' : 'off' ); ?>" <?php checked( $enable_specific_duration, 'on' ); ?>>
                                <span class="slider round"></span>
                            </label>
                        </section>
                    </div>
                            ...
                            <div style="overflow-x: auto;">
                                <table class='form-table rbfw_bike_car_sd_price_table'>
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo wp_kses( sprintf( 'Price <b class="required">*</b>', 'booking-and-rental-manager-for-woocommerce' ), array( 'b' => array( 'class' => array() ) ) ); ?></th>
                                        ...
                                        foreach ( $rbfw_bike_car_sd_data as $key => $value ):
                                            ...
                                            <tr class="rbfw_bike_car_sd_price_table_row" data-key="<?php echo esc_attr( $i ); ?>">
                                                ...
                                                <td class="rbfw_time_inventory rbfw_time_inventory_enable duration_enable <?php echo esc_attr( $manage_inventory_as_timely == 'off' ? 'rbfw_hide' : ( ( $manage_inventory_as_timely == 'on' && $enable_specific_duration == 'off' ) ? 'rbfw_hide' : '' ) ); ?>">
                                                    <?php rbfw_time_slot_select( 'start_time', $i, isset( $value['start_time'] ) ? esc_attr( $value['start_time'] ) : '' ); ?>
                                                </td>
                                                <td class="rbfw_time_inventory rbfw_time_inventory_enable duration_enable <?php echo esc_attr( $manage_inventory_as_timely == 'off' ? 'rbfw_hide' : ( ( $manage_inventory_as_timely == 'on' && $enable_specific_duration == 'off' ) ? 'rbfw_hide' : '' ) ); ?>">
                                                    <?php rbfw_time_slot_select( 'end_time', $i, isset( $value['end_time'] ) ? esc_attr( $value['end_time'] ) : '' ); ?>
                                                </td>
                                                ...
                                                <td class="rbfw_time_inventory rbfw_time_inventory_enable duration_disable <?php echo esc_attr( $manage_inventory_as_timely == 'off' ? 'rbfw_hide' : ( ( $manage_inventory_as_timely == 'on' && $enable_specific_duration == 'on' ) ? 'rbfw_hide' : '' ) ); ?>">
                                                    <select name="rbfw_bike_car_sd_data[<?php echo esc_attr( $i ); ?>][duration_type]">
                                                        <option value="hours" <?php selected( $value['duration_type'], 'hours' ); ?>><?php esc_html_e( 'Hours', 'booking-and-rental-manager-for-woocommerce' ); ?></option>
                                                        <option value="days" <?php selected( $value['duration_type'], 'days' ); ?>><?php esc_html_e( 'Days', 'booking-and-rental-manager-for-woocommerce' ); ?></option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <button type="button" class="remove_bike_car_sd_price_row"><?php esc_html_e( 'Remove', 'booking-and-rental-manager-for-woocommerce' ); ?></button>
                                                </td>
                                            </tr>
                                            <?php
                                            $i++;
                ...
                <script>
                    // Dynamically rendered data should be escaped properly here for security.
                    var rbfwItemType = <?php echo esc_js( json_encode( $rbfw_item_type ) ); ?>;
                </script>
                <?php
            }            
                    ...
                    <section>
                        <div class="w-100">
                            <div style="overflow-x: auto;">
                                <table class='form-table rbfw_bike_car_sd_price_table'>
                                    ...
                                    <tr>
                                        ...
                                        <th class="rbfw_bike_car_sd_price_table_action_column" <?php echo ( $rbfw_item_type == 'appointment' ) ? 'style="display:none"' : ''; ?>>
                                    ...
                                    if ( ! empty( $rbfw_bike_car_sd_data ) ) :
                                        ...
                                        foreach ( $rbfw_bike_car_sd_data as $key => $value ) :
                                            ...
                                            <tr class="rbfw_bike_car_sd_price_table_row" data-key="<?php echo esc_attr( $i ); ?>">
                                                <td>
                                                    <input type="text" name="rbfw_bike_car_sd_data[<?php echo esc_attr( $i ); ?>][rent_type]" value="<?php echo esc_attr( $value['rent_type'] ); ?>" placeholder="<?php esc_html_e( 'Type name', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                                </td>
                                                <td>
                                                    <input type="text" name="rbfw_bike_car_sd_data[<?php echo esc_attr( $i ); ?>][short_desc]" value="<?php echo esc_attr( $value['short_desc'] ); ?>" placeholder="<?php esc_html_e( 'Short Description', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                                </td>
                                                <td>
                                                    <input type="number" name="rbfw_bike_car_sd_data[<?php echo esc_attr( $i ); ?>][price]" step=".01" value="<?php echo esc_attr( $value['price'] ); ?>" placeholder="<?php esc_html_e( 'Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                                </td>
                                        ...
                                        <tr class="rbfw_bike_car_sd_price_table_row" data-key="0">
                                            <td>
                                                <input type="text" name="rbfw_bike_car_sd_data[0][rent_type]" value="" placeholder="<?php esc_html_e( 'Type name', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                            </td>
                                            <td>
                                                <input type="text" name="rbfw_bike_car_sd_data[0][short_desc]" value="" placeholder="<?php esc_html_e( 'Short Description', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                            </td>
                                            <td>
                                                <input type="number" name="rbfw_bike_car_sd_data[0][price]" step=".01" value="" placeholder="<?php esc_html_e( 'Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                            </td>
                                            <td class="rbfw_bike_car_sd_price_table_action_column" <?php echo ( $rbfw_item_type == 'appointment' ) ? 'style="display:none"' : ''; ?>>
                                                <input class="medium" type="number" name="rbfw_bike_car_sd_data[0][qty]" value="" placeholder="<?php esc_html_e( '(Quantity/Stock)/Day', 'booking-and-rental-manager-for-woocommerce' ); ?>"/>
                                            </td>
                                            <td class="rbfw_bike_car_sd_price_table_action_column" <?php echo ( $rbfw_item_type == 'appointment' ) ? 'style="display:none"' : ''; ?>>
                                                <div class="mp_event_remove_move">
                                                    <button class="button remove-row"><i class="fas fa-trash-can"></i></button>
                            ...
                            <p class="mt-2 <?php echo esc_attr( $rbfw_item_type == 'appointment' ? 'show' : 'show' ); ?>">
                                <button id="add-bike-car-sd-type-row" class="ppof-button" <?php echo ( $rbfw_item_type == 'appointment' ) ? 'style="display:none"' : ''; ?>>
                                    <i class="fas fa-circle-plus"></i> <?php esc_html_e( 'Add New Type', 'booking-and-rental-manager-for-woocommerce' ); ?>
                                </button>
                            </p>
                        </div>
                    </section>
			...
			public function extra_service_table( $post_id ) {
                ...
                <div class="rbfw_es_price_config_wrapper" <?php if ( $rbfw_item_type == 'appointment' ) {
                    ...
                    <?php $this->panel_header( esc_html__( 'Extra Service Price Settings', 'booking-and-rental-manager-for-woocommerce' ), esc_html__( 'Extra Service Price Settings', 'booking-and-rental-manager-for-woocommerce' ) ); ?>
                    <section>
                        <div class="w-100">
                            <div style="overflow-x: auto;">
                                <table class='rbfw_pricing_table form-table w-100' id="repeatable-fieldset-one">
                                    ...
                                    if ( ! empty( $rbfw_extra_service_data ) ) :
                                        foreach ( $rbfw_extra_service_data as $field ) {
                                            ...
                                            $service_name  = array_key_exists( 'service_name', $field ) ? esc_html( $field['service_name'] ) : '';
                                            $service_price = array_key_exists( 'service_price', $field ) ? esc_html( $field['service_price'] ) : '';
                                            $service_desc  = array_key_exists( 'service_desc', $field ) ? esc_html( $field['service_desc'] ) : '';
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="mp_formControl" name="service_name[]" placeholder="<?php esc_attr_e( 'Ex: Cap', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="<?php echo esc_attr( $service_name ); ?>"/></td>
                                                <td><input type="text" class="mp_formControl" name="service_desc[]" placeholder="<?php esc_attr_e( 'Service Description', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="<?php echo esc_attr( $service_desc ); ?>"/></td>
                                                <td><input type="number" class="medium" step="0.01" class="mp_formControl" name="service_price[]" placeholder="<?php esc_attr_e( 'Ex: 10', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="<?php echo esc_attr( $service_price ); ?>"/></td>
                                                <td><input type="number" class="medium" name="service_qty[]" placeholder="<?php esc_attr_e( 'Ex: 100', 'booking-and-rental-manager-for-woocommerce' ); ?>" value="<?php echo esc_attr( $service_qty ); ?>"/></td>
                                                <td>
                                                    <div class="mp_event_remove_move">
                                    ...
                                    <tr class="empty-row screen-reader-text">
                                        ...
                                        <td><input type="text" class="mp_formControl" name="service_name[]" placeholder="<?php esc_attr_e( 'Ex: Cap', 'booking-and-rental-manager-for-woocommerce' ); ?>"/></td>
                                        <td><input type="text" class="mp_formControl" name="service_desc[]" placeholder="<?php esc_attr_e( 'Service Description', 'booking-and-rental-manager-for-woocommerce' ); ?>" value=""/></td>
                                        <td><input type="number" class="mp_formControl medium" step="0.01" name="service_price[]" placeholder="<?php esc_attr_e( 'Ex: 10', 'booking-and-rental-manager-for-woocommerce' ); ?>" value=""/></td>
                                        <td><input type="number" class="medium" name="service_qty[]" placeholder="<?php esc_attr_e( 'Ex: 100', 'booking-and-rental-manager-for-woocommerce' ); ?>" value=""/></td>
                                        <td>
                                            <div class="mp_event_remove_move">
                                                <button class="button remove-row"><i class="fas fa-trash-can"></i></button>
                                                <div class="button mp_event_type_sortable_button"><i class="fas fa-arrows-alt"></i></div>
			...
			public function resort_price_config( $post_id ) {
                // Use esc_attr for attributes and check for escaping
                ...
                ?>
                <div class="rbfw_resort_price_config_wrapper" style="display: <?php echo esc_attr( ( $rbfw_item_type == 'resort' ) ? 'block' : 'none' ); ?>;">
                    ...
                    <section>
                        ...
                        <label class="switch">
                            <input type="checkbox" name="rbfw_enable_resort_daylong_price" value="<?php echo esc_attr( $rbfw_enable_resort_daylong_price ); ?>" <?php echo esc_attr( ( $rbfw_enable_resort_daylong_price == 'yes' ) ? 'checked' : '' ); ?>>
                            <span class="slider round"></span>
                        </label>
                    </section>
                    <section>
                                        ...
                                        if ( ! empty( $rbfw_resort_room_data ) ) :
                                            ...
                                            foreach ( $rbfw_resort_room_data as $key => $value ):
                                                ...
                                                <tr class="rbfw_resort_price_table_row" data-key="<?php echo esc_attr( $i ); ?>">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a class="rbfw_room_type_image_btn button" href="#"><?php esc_html_e( 'Add Image', 'booking-and-rental-manager-for-woocommerce' ); ?></a><a class="rbfw_remove_room_type_image_btn button" href="#"><?php esc_html_e( 'Remove Image', 'booking-and-rental-manager-for-woocommerce' ); ?></a>
                                                    ...
                                                    <td class="resort_day_long_price" style="display: <?php echo esc_attr( ( $rbfw_item_type == 'resort' && $rbfw_enable_resort_daylong_price == 'yes' ) ? 'table-cell' : 'none' ); ?>">
                                                        <input type="number" class="medium" name="rbfw_resort_room_data[<?php echo esc_attr( $i ); ?>][rbfw_room_daylong_rate]" step=".01" value="<?php echo esc_attr( $value['rbfw_room_daylong_rate'] ); ?>" placeholder="<?php esc_html_e( 'Day-long Price', 'booking-and-rental-manager-for-woocommerce' ); ?>">
                                                    </td>
                                            ...
                                            <tr class="rbfw_resort_price_table_row" data-key="0">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="rbfw_room_type_image_btn button" href="#"><i class="fas fa-circle-plus"></i> </a><a class="rbfw_remove_room_type_image_btn button" href="#"><i class="fas fa-circle-minus"></i></a>
                                                    <input type="hidden" name="rbfw_resort_room_data[0][rbfw_room_image]" value="" class="rbfw_room_image"/>
                                                </td>
                                                <td class="resort_day_long_price" style="display: <?php echo esc_attr( ( $rbfw_item_type == 'resort' && $rbfw_enable_resort_daylong_price == 'yes' ) ? 'block' : 'none' ); ?>">
                                                    <input type="number" class="medium" name="rbfw_resort_room_data[0][rbfw_room_daylong_rate]" step=".01" value="" placeholder="<?php esc_html_e( 'Day-long Price', 'booking-and-rental-manager-for-woocommerce' ); ?>">
                                                </td>
			...
			public function rbfw_day_row( $day_name, $day_slug ) {
                ...
                <tr>
                    ...
                    <td><input type="number" name='rbfw_<?php echo esc_attr( $day_slug ); ?>_hourly_rate' value="<?php echo esc_attr( $hourly_rate ); ?>" placeholder="<?php esc_html_e( 'Hourly Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"></td>
                    <td><input type="number" name='rbfw_<?php echo esc_attr( $day_slug ); ?>_daily_rate' value="<?php echo esc_attr( $daily_rate ); ?>" placeholder="<?php esc_html_e( 'Daily Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"></td>
                    <td><input type="checkbox" name='rbfw_enable_<?php echo esc_attr( $day_slug ); ?>_day' value='yes' <?php checked( $enable, 'yes' ); ?> ></td>
                </tr>
                <?php
            }            
			...
			public function appointment( $post_id ) {
                $rbfw_item_type                          = get_post_meta( $post_id, 'rbfw_item_type', true ) ?: 'bike_car_sd';
                $rbfw_sd_appointment_ondays_data         = get_post_meta( $post_id, 'rbfw_sd_appointment_ondays', true ) ?: [];
                $rbfw_sd_appointment_max_qty_per_session = get_post_meta( $post_id, 'rbfw_sd_appointment_max_qty_per_session', true ) ?: 'appointment';
                ?>
                    ...
                    <div class="rbfw_appointment_ondays_wrap">
                        ...
                        ?>
                            <div class="rbfw_appointment_ondays_value">
                                <input type="checkbox" name="rbfw_sd_appointment_ondays[]" value="<?php echo esc_attr( $day ); ?>" <?php checked( in_array( $day, $rbfw_sd_appointment_ondays_data ) ); ?>>
                                <span><?php esc_html_e( $day, 'booking-and-rental-manager-for-woocommerce' ); ?></span>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </section>
			...
			public function general_price_config( $post_id ) {
                ...
                <?php $this->panel_header( esc_html( 'General Price Configuration' ), esc_html( 'General Price Configuration' ) ); ?>
                ...
                <section>
                    ...
                    <div>
                        <label class="switch">
                            <input type="checkbox" name="rbfw_enable_daily_rate" value="<?php echo esc_attr( $rbfw_enable_daily_rate ); ?>" <?php echo ( 'yes' === $rbfw_enable_daily_rate ) ? 'checked' : ''; ?>>
                            <span class="slider round"></span>
                        </label>
                        <span class="rbfw_daily_rate_input ms-2">
                            <input type="number" name="rbfw_daily_rate" step="0.01" value="<?php echo esc_attr( $rbfw_daily_rate ); ?>" placeholder="<?php esc_html_e( 'Daily Price', 'booking-and-rental-manager-for-woocommerce' ); ?>" <?php echo ( 'no' === $rbfw_enable_daily_rate ) ? 'disabled' : ''; ?>>
                        </span>
                    </div>
                </section>
                <section>
                    ...
                    <div>
                        <label class="switch">
                            <input type="checkbox" name="rbfw_enable_hourly_rate" value="<?php echo esc_attr( $rbfw_enable_hourly_rate ); ?>" <?php echo ( 'yes' === $rbfw_enable_hourly_rate ) ? 'checked' : ''; ?>>
                            <span class="slider round"></span>
                        </label>
                        <span class="rbfw_hourly_rate ms-2">
                            <input type="number" name="rbfw_hourly_rate" step="0.01" value="<?php echo esc_attr( $rbfw_hourly_rate ); ?>" placeholder="<?php esc_html_e( 'Hourly Price', 'booking-and-rental-manager-for-woocommerce' ); ?>" <?php echo ( 'no' === $rbfw_enable_hourly_rate ) ? 'disabled' : ''; ?>>
                        </span>
                    </div>
                </section>
                <?php $this->panel_header( esc_html( 'Day-wise Price Configuration' ), esc_html( 'Day-wise Price Configuration lets you set different prices for each day of the week' ) ); ?>
                <section>
                    <div>
                        <label>
                    ...
                    <label class="switch">
                        <input type="checkbox" name="rbfw_enable_daywise_price" value="<?php echo esc_attr( $rbfw_enable_daywise_price ); ?>" <?php echo ( 'yes' === $rbfw_enable_daywise_price ) ? 'checked' : ''; ?>>
                        <span class="slider round"></span>
                    </label>
                </section>
                <section class="day-wise-price-configuration <?php echo ( 'yes' === $rbfw_enable_daywise_price ) ? 'show' : 'hide'; ?>">
                ...
                <script>
                        ...
                        function rbfw_service_image_addup() {
                            ...
                            jQuery('.rbfw_service_image_btn').click(function () {
                                ...
                                wp.media.editor.send.attachment = function (props, attachment) {
                                    ...
                                    target.find('.rbfw_service_image').val( esc_attr( attachment.id ) );
                    ...
                    jQuery('#add-resort-type-row').click(function (e) {
                        ...
                        if (jQuery('.rbfw_resort_price_table .rbfw_resort_price_table_row').length) {
                            ...
                            let resort_type_row = '<tr class="rbfw_resort_price_table_row" data-key="' + resort_type_new_data_key + '"><td><input type="text" name="rbfw_resort_room_data[' + resort_type_new_data_key + '][room_type]" value="" placeholder="<?php echo esc_attr( __( 'Room type', 'your-text-domain' ) ); ?>"></td><td class="text-center"><div class="rbfw_room_type_image_preview"></div><a class="rbfw_room_type_image_btn button"><i class="fas fa-circle-plus"></i></a><a class="rbfw_remove_room_type_image_btn button"><i class="fas fa-circle-minus"></i></a><input type="hidden"  name="rbfw_resort_room_data[' + resort_type_new_data_key + '][rbfw_room_image]" value="" class="rbfw_room_image"></td><td class="resort_day_long_price" style="display: none;"><input type="number" class="medium" name="rbfw_resort_room_data[' + resort_type_new_data_key + '][rbfw_room_daylong_rate]" step=".01" value="" placeholder="<?php echo esc_attr( __( 'Day-long Rate', 'your-text-domain' ) ); ?>"></td><td><input type="number" class="medium" name="rbfw_resort_room_data[' + resort_type_new_data_key + '][rbfw_room_daynight_rate]" step=".01" value="" placeholder="<?php echo esc_attr( __( 'Day-night Rate', 'your-text-domain' ) ); ?>"></td><td><input type="text" name="rbfw_resort_room_data[' + resort_type_new_data_key + '][rbfw_room_desc]" value="" placeholder="<?php echo esc_attr( __( 'Short Description', 'your-text-domain' ) ); ?>"></td><td><input type="number" class="medium" name="rbfw_resort_room_data[' + resort_type_new_data_key + '][rbfw_room_available_qty]" value="" placeholder="<?php echo esc_attr( __( 'Available Qty', 'your-text-domain' ) ); ?>"></td><td><div class="mp_event_remove_move"><button class="button remove-row ' + current_time + '"><i class="fas fa-trash-can"></i></button><div class="button mp_event_type_sortable_button"><i class="fas fa-arrows-alt"></i></div></div></td></tr>';
                        ...
                        jQuery('.remove-row.' + current_time + '').on('click', function () {
                            e.preventDefault();
                            e.stopImmediatePropagation();
                            if (confirm('<?php echo esc_js( __( 'Are You Sure, Remove this row?', 'your-text-domain' ) ); ?>')) {
                    ...
                    function rbfw_room_type_image_addup() {
                        jQuery('.rbfw_room_type_image_btn').click(function () {
                            ...
                            wp.media.editor.send.attachment = function (props, attachment) {
                                ...
                                jQuery('.rbfw_resort_price_table_row[data-key=' + parent_data_key + '] .rbfw_room_type_image_preview').append('<img src="' + esc_url( attachment.url ) + '"/>');
                                jQuery('.rbfw_resort_price_table_row[data-key=' + parent_data_key + '] .rbfw_room_image').val( esc_attr( attachment.id ) );
                                wp.media.editor.send.attachment = send_attachment_bkp;
                            }
                            wp.media.editor.open(jQuery(this));
                            return false;
