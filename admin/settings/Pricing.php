        ...
        class RBFW_Pricing{
                    ...
                    <section>
						<div class="w-100">
							<div style="overflow-x: auto;">
                                ...
                                <?php echo $manage_inventory_as_timely; ?>
								...
								<table class='form-table rbfw_bike_car_sd_price_table'>
									<thead>
										<tr>
											...
											<th class="rbfw_without_time_inventory <?php echo ($manage_inventory_as_timely=='on')?'rbfw_hide':'' ?>"><?php _e( 'Stock/Day <b class="required">*</b>', 'booking-and-rental-manager-for-woocommerce' ); ?></th>
                                            <th class="rbfw_time_inventory <?php echo ($manage_inventory_as_timely=='no')?'rbfw_hide':''  ?>">
											...
											<th class="rbfw_bike_car_sd_price_table_action_column"><?php _e( 'Action', 'booking-and-rental-manager-for-woocommerce' ); ?></th>
										</tr>
									</thead>
									...
									?>
										<tr class="rbfw_bike_car_sd_price_table_row" data-key="<?php echo mep_esc_html($i); ?>">
                                            ...
                                            <td class="rbfw_without_time_inventory <?php echo ($manage_inventory_as_timely=='on')?'rbfw_hide':'' ?>""><input class="medium" type="number" name="rbfw_bike_car_sd_data[<?php echo mep_esc_html($i); ?>][qty]" value="<?php echo esc_attr( $value['qty'] ); ?>" placeholder="<?php esc_html_e( 'Stock Quantity', 'booking-and-rental-manager-for-woocommerce' ); ?>" /></td>

                                            <td class="rbfw_time_inventory <?php echo ($manage_inventory_as_timely=='no')?'rbfw_hide':''  ?>"><input class="medium" type="number" name="rbfw_bike_car_sd_data_duration[<?php echo mep_esc_html($i); ?>][qty]" value="<?php echo esc_attr( $value['qty'] ); ?>" placeholder="<?php esc_html_e( 'Stock Quantity', 'booking-and-rental-manager-for-woocommerce' ); ?>" /></td>
                                            <td class="rbfw_time_inventory <?php echo ($manage_inventory_as_timely=='no')?'rbfw_hide':''  ?>">
                                                <select name="rbfw_bike_car_sd_data_duration[<?php echo mep_esc_html($i); ?>][d_type]">
                                                    <option <?php echo ( $value['d_type'] =='Hours')?'selected':''; ?> value="Hours">Hours</option>
                                                    <option <?php echo ( $value['d_type'] =='Days')?'selected':''; ?> value="Days">Days</option>
                                                    <option <?php echo ( $value['d_type'] =='Weeks')?'selected':''; ?> value="Weeks">Weeks</option>
                                                </select>
                                            </td>
							...
							<p class="mt-2 <?php echo esc_attr($rbfw_item_type == 'appointment'? 'show':'show'); ?>" >
								<button id="add-bike-car-sd-type-row" data-post_id="<?php echo $post_id ?>" class="ppof-button" <?php if($rbfw_item_type == 'appointment'){ echo 'style="display:none"'; } ?>><i class="fa-solid fa-circle-plus"></i> <?php esc_html_e( 'Add New Type', 'booking-and-rental-manager-for-woocommerce' ); ?></button>
							</p>
						</div>
					</section>
            ...
            public function bike_car_single_day_duration($post_id){
                ...
                <div class="rbfw_bike_car_sd_wrapper <?php  echo esc_attr($rbfw_item_type == 'bike_car_sd' || $rbfw_item_type == 'appointment' )?'show':'hide'; ?>" >
                    <section>
                        <div class="w-100">
                            <div style="overflow-x: auto;">
                                <h3>Single Item with inventory</h3>
						...
						<div style="overflow-x:auto;">
							<table class='form-table rbfw_resort_price_table w-100'>
								...
								<tr class="rbfw_resort_price_table_row" data-key="<?php echo mep_esc_html($i); ?>">
									...
									<td class="resort_day_long_price" style="display: <?php if (($rbfw_item_type == 'resort') && $rbfw_enable_resort_daylong_price == 'yes') { echo esc_attr( 'table-cell' ); } else { echo esc_attr( 'none' ); } ?>;"><input type="number" class="medium" name="rbfw_resort_room_data[<?php echo mep_esc_html($i); ?>][rbfw_room_daylong_rate]" step=".01" value="<?php echo esc_attr( $value['rbfw_room_daylong_rate'] ); ?>" placeholder="<?php esc_html_e( 'Day-long Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"></td>
									<td><input type="number" class="medium" name="rbfw_resort_room_data[<?php echo mep_esc_html($i); ?>][rbfw_room_daynight_rate]" step=".01" value="<?php echo esc_attr( $value['rbfw_room_daynight_rate'] ); ?>" placeholder="<?php esc_html_e( 'Day-night Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"></td>
									...
									<td><input type="number" class="medium" name="rbfw_resort_room_data[<?php echo mep_esc_html($i); ?>][rbfw_room_available_qty]" step=".01" value="<?php echo esc_attr( $value['rbfw_room_available_qty'] ); ?>" placeholder="<?php esc_attr_e( 'Stock Quantity', 'booking-and-rental-manager-for-woocommerce' ); ?>"></td>
									<td>
									<div class="mp_event_remove_move">
										<button class="button remove-row"><i class="fa-solid fa-trash-can"></i></button><div class="button mp_event_type_sortable_button"><i class="fas fa-arrows-alt"></i></div>
									</div>
								...
								<tr class="rbfw_resort_price_table_row" data-key="0">
									...
									<td class="resort_day_long_price"  style="display: <?php if (($rbfw_item_type == 'resort') && $rbfw_enable_resort_daylong_price == 'yes') { echo esc_attr( 'block' ); } else { echo esc_attr( 'none' ); } ?>;"><input type="number" class="medium" name="rbfw_resort_room_data[0][rbfw_room_daylong_rate]" step=".01" value="" placeholder="<?php esc_html_e( 'Day-long Price', 'booking-and-rental-manager-for-woocommerce' ); ?>"></td>
			...
			?>
				...
				<script>
					...
					jQuery(document).ready(function(){
						...
						jQuery('#add-bike-car-sd-type-row_____________').click(function (e) {
							e.preventDefault();
			...
			public function settings_save($post_id) {
                ...
                if ( get_post_type( $post_id ) == 'rbfw_item' ) {
					...
					$manage_inventory_as_timely             = isset( $_POST['manage_inventory_as_timely'] ) ? rbfw_array_strip( $_POST['manage_inventory_as_timely'] ) : 'no';
