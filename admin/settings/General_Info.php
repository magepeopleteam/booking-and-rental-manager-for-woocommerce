																	...
																	<?php
																		if ( ! empty( $value['cat_features'] ) ) {
																			...
																			foreach ( $value['cat_features'] as $feature ) {
																				...
																				?>
                                                                                <div class="item">
                                                                                    <a href="#rbfw_features_icon_list_wrapper" class="rbfw_feature_icon_btn btn" data-key="<?php echo esc_attr( $c ); ?>"><i class="fas fa-circle-plus"></i> </a>
			...
			public function features_category( $post_id ) {
                ...
                <script type="text/javascript">
                    ...
                    jQuery(document).on('click', '.add-new-feature', function (e) {
                        ...
                        html += '<i class="fas fa-circle-plus"></i> ';
                        html += '</a>';
