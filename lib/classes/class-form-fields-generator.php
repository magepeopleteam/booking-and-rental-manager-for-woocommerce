		...
		class FormFieldsGenerator {
			...
			public function field_margin( $option ) {
				...
				if ( ! empty( $args ) ):
                    ...
                    <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo esc_attr( $depends ); ?>]" <?php } ?> id="field-wrapper-<?php echo esc_attr( $id ); ?>" class="<?php if ( ! empty( $depends ) ) {
						echo 'dependency-field';
					} ?> field-wrapper field-margin-wrapper field-margin-wrapper-<?php echo esc_attr( $id ); ?>">
                        <label><input type="checkbox" class="change-together">Apply for all</label>
                        <div class="item-list">
							<?php
								foreach ( $args as $index => $arg ):
			...
			public function field_url( $option ) {
				...
				ob_start();
				?>
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo esc_attr( $depends ); ?>]" <?php } ?> class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-url-wrapper field-url-wrapper-<?php echo esc_attr( $id ); ?>">
...
"><?php echo wp_kses_post( $remove_text ); ?></span>
			...
			public function field_textarea( $option ) {
                ...
                <div <?php if ( ! empty( $depends ) ) { ?> data-depends="[<?php echo esc_attr( $depends ); ?>]" <?php } ?>
                    id="field-wrapper-<?php echo esc_attr( $id ); ?>" class="<?php if ( ! empty( $depends ) ) {
					echo 'dependency-field';
				} ?> field-wrapper field-textarea-wrapper field-textarea-wrapper-<?php echo esc_attr( $field_id ); ?>">
            ...
            field-link-color-wrapper-<?php echo esc_attr( $id ); ?>">
					<?php
						if ( ! empty( $values ) && is_array( $values ) ):
							foreach ( $args as $argindex => $value ):
								?>
                                <div>
                                    <div class="item"><span class="title">a:<?php echo esc_html( $argindex ); ?> Color</span>
                                        <div class="colorpicker"><input type='text' class='<?php echo esc_attr( $id ); ?>' name='<?php echo esc_attr( $field_name ); ?>[<?php echo esc_attr( $argindex ); ?>]' value='<?php echo esc_attr( $values[ $argindex ] ); ?>'/></div>
                                    </div>
                                </div>
							<?php
							endforeach;
							...
							foreach ( $args as $argindex => $value ):
                                ...
                                <div>
                                    <div class="item"><span class="title">a:<?php echo esc_html( $argindex ); ?> Color</span>
                                        <div class="colorpicker"><input type='text' class='<?php echo esc_attr( $id ); ?>' name='<?php echo esc_attr( $field_name ); ?>[<?php echo esc_attr( $argindex ); ?>]' value='<?php echo esc_attr( $value ); ?>'/></div>
                                    </div>
                                </div>
							<?php
							endforeach;
                ...
                <script>jQuery(document).ready(function ($) {
                        $('.<?php echo esc_attr( $id ); ?>').wpColorPicker();
                    });</script>
				<?php
				return ob_get_clean();
			}
...
// $value = preg_replace('/^[ \t]*[\r\n]+/m', '', $value);
            ...
            field-option-group-tabs-wrapper-<?php echo esc_attr( $id ); ?>">
                    <ul class="tab-navs">
						<?php
							...
							foreach ( $args as $key => $value ):
								$title = $value['title'];
								?>
                                <li index="<?php echo esc_attr( $i ); ?>" class="<?php if ( $i == 1 ) {
									echo 'active';
								} ?>"><?php echo esc_html( $title ); ?></li>
								<?php
								$i ++;
							endforeach;
						?>
					...
					<?php
						...
						foreach ( $args as $key => $value ):
							...
							?>
                            <div class="tab-content tab-content-<?php echo esc_attr( $i ); ?> <?php if ( $i == 1 ) {
								echo 'active';
							} ?>">
								<?php
									if ( ! empty( $options ) ):
            ...
            field-color-sets-wrapper-<?php echo esc_attr( $id ); ?>">
                ...
                <style type="text/css">
                    ...
                    <?php endif; ?><?php if(!empty($height)):  ?> height: <?php echo esc_attr($height); ?>;
                    <?php endif; ?>
					}
            ...
            field-media-wrapper-<?php echo esc_attr( $id ); ?>">
                    ...
                    <div class='ppof-button upload' id='media_upload_<?php echo esc_attr( $id ); ?>'><?php echo esc_html_e( 'Upload', 'booking-and-rental-manager-for-woocommerce' ); ?></div>
                    <div class='ppof-button clear' id='media_clear_<?php echo esc_attr( $id ); ?>'><?php echo esc_html_e( 'Clear', 'booking-and-rental-manager-for-woocommerce' ); ?></div>
                    <div class="error-mgs"></div>
                </div>
                <script>jQuery(document).ready(function ($) {
                        $('#media_upload_<?php echo esc_attr( $id ); ?>').click(function () {
			...
			public function get_tax_data( $args ) {
				foreach ( $this->get_rep_taxonomies_array( $args ) as $argIndex => $argName ):
					$selected = ( $argIndex == $argName ) ? 'selected' : ''; ?>
                    <option <?php echo esc_attr( $selected ); ?>  value="<?php echo esc_attr( $argIndex ); ?>"><?php echo esc_html( $argName ); ?></option> <?php endforeach;
			}
			...
			public function args_from_string( $string ) {
				...
				if ( strpos( $string, 'TAXN_' ) !== false ) {
					return $this->get_rep_taxonomies_array( $string );
				}
				if ( strpos( $string, 'CPT_' ) !== false ) {
					return $this->get_cpt_array( $string );
				}
