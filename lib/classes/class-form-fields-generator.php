...
// Verify the token on the server.
        ...
        public function field_text_multi( $option ){
            ...
            field-text-multi-wrapper-<?php echo esc_attr($field_id); ?>">
                ...
                <div class="field-list <?php if($sortable){ echo 'sortable'; }?>" id="<?php echo esc_attr($field_id); ?>">
                    ...
                    if(!empty($values)):
                        ...
                        foreach ($values as $value):
                            ?>
                            <div class="item">
                                <div class="rbfw_feature_icon_preview" data-key="<?php echo mep_esc_html($i); ?>"><?php if($value["icon"]){ echo '<i class="'.$value["icon"].'"></i>'; } ?></div>
                                <a href="#rbfw_features_icon_list_wrapper" class="rbfw_feature_icon_btn" data-key="<?php echo mep_esc_html($i); ?>"><?php echo esc_html__('Icon Library','booking-and-rental-manager-for-woocommerce'); ?></a>
                                <input type='hidden' name='<?php echo esc_attr($field_name); ?>[<?php echo mep_esc_html($i); ?>][icon]' placeholder='<?php echo esc_attr__('Icon','booking-and-rental-manager-for-woocommerce'); ?>' value='<?php echo esc_attr($value["icon"]); ?>' data-key="<?php echo mep_esc_html($i); ?>" class="rbfw_feature_icon"/>
                                <input type='text' name='<?php echo esc_attr($field_name); ?>[<?php echo mep_esc_html($i); ?>][title]'  placeholder='<?php echo esc_attr($placeholder); ?>' value="<?php  echo esc_attr($value["title"]); ?>" data-key="<?php echo mep_esc_html($i); ?>"/>
                        ...
                        <div class="item">
                            ...
                            <a href="#rbfw_features_icon_list_wrapper" class="rbfw_feature_icon_btn" data-key="0"><?php echo esc_html__('Icon Library','booking-and-rental-manager-for-woocommerce'); ?></a>
                            <input type='hidden' name='<?php echo esc_attr($field_name); ?>[0][icon]' placeholder='<?php echo esc_attr__('Icon','booking-and-rental-manager-for-woocommerce'); ?>' data-key="0" class="rbfw_feature_icon"/>
                            <input type='text' name='<?php echo esc_attr($field_name); ?>[0][title]'  placeholder='<?php echo esc_attr($placeholder); ?>' value='' data-key="0"/>
                             <!--  <span class="button clone"><i class="far fa-clone"></i></span>-->
                            <?php if($sortable):?>
                            <span class="button sort"><i class="fas fa-arrows-alt"></i></span>
                            <?php endif; ?>
                ...
                <span class="ppof-button add-item"><i class="fa-solid fa-circle-plus"></i> <?php echo __('Add New Feature','booking-and-rental-manager-for-woocommerce'); ?></span>
                ...
                <script>
                    ...
                    jQuery(document).on('click', '.field-text-multi-wrapper-<?php echo esc_attr($id); ?> .add-item',function(){
                        let data_key = jQuery(this).siblings("#rbfw_highlights_texts").find("div.item:last-child input" ).attr('data-key');
                        let i = parseInt(data_key);
                        let c = i + 1;
                        
                        html_<?php echo esc_attr($id); ?> = '<div class="item">';
                        html_<?php echo esc_attr($id); ?> += '<div class="rbfw_feature_icon_preview" data-key="'+ c +'"></div>';
                        html_<?php echo esc_attr($id); ?> += '<a href="#rbfw_features_icon_list_wrapper" class="rbfw_feature_icon_btn" data-key="'+ c +'"><?php echo esc_html__('Icon Library','booking-and-rental-manager-for-woocommerce'); ?></a>';
                        html_<?php echo esc_attr($id); ?> += '<input type="hidden" name="<?php echo esc_attr($field_name); ?>['+ c +'][icon]" placeholder="<?php
                            echo esc_html__('Icon','booking-and-rental-manager-for-woocommerce'); ?>" data-key="'+ c +'" class="rbfw_feature_icon"/>';
                        html_<?php echo esc_attr($id); ?> += '<input type="text" name="<?php echo esc_attr($field_name); ?>['+ c +'][title]" placeholder="<?php
