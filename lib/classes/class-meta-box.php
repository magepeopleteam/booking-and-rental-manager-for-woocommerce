		...
		class RMFWAddMetaBox {
                                                    ...
                                                    <div class="d-flex flex-column w-70">
														<?php
															...
															if ( is_serialized( $option_value ) ) {
																$option_value = rbfw_safe_unserialize( $option_value );
															}
			...
			public function field_generator( $option ) {
				...
				if ( ! empty( $prent_option_name ) ) :
					...
					$prent_option_value   = is_serialized( $prent_option_value ) ? rbfw_safe_unserialize( $prent_option_value ) : array();
					...
					$option['value']      = is_serialized( $option_value ) ? rbfw_safe_unserialize( $option_value ) : $option_value;
				endif;
