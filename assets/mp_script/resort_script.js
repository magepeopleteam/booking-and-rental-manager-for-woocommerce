...
jQuery(document).on('click','.rbfw_chk_availability_btn',function(e) {
    e.preventDefault();
    let checkin_date_notice 	= "<?php echo esc_html__('Please Choose Check-In Date','booking-and-rental-manager-for-woocommerce'); ?>";
    let checkout_date_notice 	= "<?php echo esc_html__('Please Choose Check-Out Date','booking-and-rental-manager-for-woocommerce'); ?>";
